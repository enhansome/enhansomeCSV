...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,792 | 🐛 34 | 🌐 Rust | 📅 2026-09-22 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,095 | 🐛 160 | 📅 2026-09-21 - A topic-centric list of high-quality open datasets in public domains.
...
* [structured-text-tools](https://github.com/dbohdan/structured-text-tools) ⭐ 7,148 | 🐛 7 | 📅 2026-08-12 - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
