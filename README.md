...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,786 | 🐛 31 | 🌐 Rust | 📅 2026-09-14 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,940 | 🐛 158 | 📅 2026-09-13 - A topic-centric list of high-quality open datasets in public domains.
...
* [structured-text-tools](https://github.com/dbohdan/structured-text-tools) ⭐ 7,144 | 🐛 7 | 📅 2026-08-12 - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
