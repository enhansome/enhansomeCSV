...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,776 | 🐛 34 | 🌐 Rust | 📅 2026-09-09 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [CSV to Table](https://github.com/vividvilla/csvtotable) ⭐ 1,181 | 🐛 6 | 🌐 Go | 📅 2026-08-24 - Convert CSV files to searchable and sortable HTML table.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,876 | 🐛 158 | 📅 2026-09-08 - A topic-centric list of high-quality open datasets in public domains.
