...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,786 | 🐛 31 | 🌐 Rust | 📅 2026-09-15 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [Data Wrangler](https://github.com/microsoft/vscode-data-wrangler) ⭐ 609 | 🐛 270 | 📅 2025-12-03 - Data Wrangler is a code-centric data cleaning tool that is integrated into VS Code and VS Code Jupyter Notebooks.
...
* [Csvlint.go](https://github.com/Clever/csvlint) ⭐ 209 | 🐛 14 | 🌐 Makefile | 📅 2025-11-05 - Command line tool for validating CSV files against RFC 4180.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,956 | 🐛 158 | 📅 2026-09-14 - A topic-centric list of high-quality open datasets in public domains.
