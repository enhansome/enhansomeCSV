...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,789 | 🐛 32 | 🌐 Rust | 📅 2026-09-19 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,049 | 🐛 160 | 📅 2026-09-18 - A topic-centric list of high-quality open datasets in public domains.
...
* [structured-text-tools](https://github.com/dbohdan/structured-text-tools) ⭐ 7,145 | 🐛 7 | 📅 2026-08-12 - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
