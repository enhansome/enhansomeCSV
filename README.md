...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,764 | 🐛 30 | 🌐 Rust | 📅 2026-08-21 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [Data Wrangler](https://github.com/microsoft/vscode-data-wrangler) ⭐ 607 | 🐛 267 | 📅 2025-12-03 - Data Wrangler is a code-centric data cleaning tool that is integrated into VS Code and VS Code Jupyter Notebooks.
...
* [CSV to Table](https://github.com/vividvilla/csvtotable) ⭐ 1,174 | 🐛 5 | 🌐 Go | 📅 2026-08-21 - Convert CSV files to searchable and sortable HTML table.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,395 | 🐛 159 | 📅 2026-08-21 - A topic-centric list of high-quality open datasets in public domains.
...
* [structured-text-tools](https://github.com/dbohdan/structured-text-tools) ⭐ 7,144 | 🐛 5 | 📅 2026-08-12 - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
