...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,796 | 🐛 34 | 🌐 Rust | 📅 2026-09-26 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [CSV to Table](https://github.com/vividvilla/csvtotable) ⭐ 1,184 | 🐛 7 | 🌐 Go | 📅 2026-08-24 - Convert CSV files to searchable and sortable HTML table.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,157 | 🐛 161 | 📅 2026-09-23 - A topic-centric list of high-quality open datasets in public domains.
...
* [structured-text-tools](https://github.com/dbohdan/structured-text-tools) ⭐ 7,149 | 🐛 7 | 📅 2026-08-12 - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
